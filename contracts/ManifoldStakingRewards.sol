...
import "./IManifoldStakingRewards.sol";
import "./synthetix/contracts/RewardsDistributionRecipient.sol";

// TODO Utilize Error code prefix's 
contract ManifoldStakingRewards is IManifoldStakingRewards, RewardsDistributionRecipient, ReentrancyGuard {
    ...
    function recoverERC20(address tokenAddress, uint256 tokenAmount) external onlyOwner {
        require(tokenAddress != address(stakingToken), "ERROR: unable to withdraw");
    ...
    function setRewardsDuration(uint256 _rewardsDuration) external onlyOwner {
        require(
            ...
            "ERROR: Previous rewards period overlap"
        );
